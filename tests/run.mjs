...
const result = spawnSync(process.execPath, ['--test', '--test-reporter=tap',
  'tests/config.test.mjs', 'tests/cloud-config.test.mjs', 'tests/edge-function.test.mjs', 'tests/product-photo-edge.test.mjs', 'tests/pricing.test.mjs', 'tests/data.test.mjs', 'tests/smoke.test.mjs', 'tests/browser.test.mjs'],
